...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/secretsmanager/$Module.txt");
    ...
    public $Module() {
        super("secretsmanager", "0.0.0", $Module.class, "secretsmanager@0.0.0.jsii.tgz");
    }
