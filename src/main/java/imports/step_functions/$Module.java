...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/step_functions/$Module.txt");
    ...
    public $Module() {
        super("step-functions", "0.0.0", $Module.class, "step-functions@0.0.0.jsii.tgz");
    }
